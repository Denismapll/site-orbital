...
<body>
	<section style="height: 80vh" class="mt-3 mb-3" data-aos="fade-down" data-aos-easing="" data-aos-duration="1000">
	...
	background-position: right;">
			<div class="col-md-6">
				...
				<div class="row flex-row">
					<button type="button" style="width: fit-content;" class="btn btn-primary m-2 p-4 fs-4 rounded fw-bold" data-aos="fade-down" data-aos-delay="1000">SER REPRESENTANTE</button>
					<button type="button" style="width: fit-content;" class="btn btn-dark m-2 p-4 fs-4 rounded fw-bold" data-aos="fade-down" data-aos-delay="1000">PRODUTOS</button>
				</div>
			</div>
		</div>
	</section>

	<section style="height: 20vh" class="mt-3 mb-3" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
	...
	<section style="margin-bottom: 120px;">
		<div class="container">
			<div class="row justify-content-around">
				<div class="col-md-3 col-6" data-aos="fade-down" data-aos-easing="" data-aos-duration="2000" data-aos-delay="200">
				...
				<div class="col-md-3 col-6" data-aos="fade-down" data-aos-easing="" data-aos-duration="2000" data-aos-delay="400">
				...
				<div class="col-md-3 col-6" data-aos="fade-down" data-aos-easing="" data-aos-duration="2000" data-aos-delay="600">
				...
				<div class="col-md-3 col-6" data-aos="fade-down" data-aos-easing="" data-aos-duration="2000" data-aos-delay="800">
	...
	<section style="margin-bottom: 120px;">
		<div class="container">
			<div class="col-12" data-aos="fade-right">
				...
				<p style="text-align: right;"><a style="color: black; text-decoration: none" href="<?php echo home_url();?>/informacoes">Ver Todos<br><img style="width: 12px;" src="<?= wp_upload_dir()['baseurl'] ?>/2024/06/seta-direita.png" alt="" srcset=""></a></p>
			</div>
			<div class="row">
	...
	<section style="height: 70vh; margin-bottom: 120px;" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
