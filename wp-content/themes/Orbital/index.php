		...
		<div class="container">
			<div class="row justify-content-around">
				<div class="col-md-3 col-6">
					<div class="bg-pecas"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/rabetas-index.png');">
				...
				<div class="col-md-3 col-6">
					<div class="bg-pecas"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/rear-index.png');">
						<p style="font-size: 16px; font-weight: 800;" class="text-right"><a href="#">VER</a></p>
						<div class="abs">
				...
				<div class="col-md-3 col-6">
					<div class="bg-pecas"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/pedaleiras-index.png');">
						<p style="font-size: 16px; font-weight: 800;" class="text-right"><a href="#">VER</a></p>
						<div class="abs">
				...
				<div class="col-md-3 col-6">
					<div class="bg-pecas"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/protetor-index.png');">
						<p style="font-size: 16px; font-weight: 800;" class="text-right"><a href="#">VER</a></p>
						<div class="abs">
		...
		<div class="container">
			<div class="col-12">
				...
				<p style="text-align: right;"><a style="color: black; text-decoration: none" href="#">Ver Todos<br><img
							style="width: 12px;"
							src="<?=wp_upload_dir()['baseurl']?>/2024/06/seta-direita.png" alt=""
							srcset=""></a></p>
			</div>
			<div class="row">
				<div class="col-md-4 col-12" style="padding: 20px;">
					<div class="bg-destaques"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/roldana.jpg')">
				...
				<div class="col-md-4 col-12" style="padding: 20px;">
					<div class="bg-destaques"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/pedal.jpg')">
						<div class="abs-destaques">
				...
				<div class="col-md-4 col-12" style="padding: 20px;">
					<div class="bg-destaques"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/carcaca.jpg')">
						<div class="abs-destaques">
			...
			<div class="row" style="min-height: 400px;">
				<div class="col-md-8 col-12">
						...
						<div class="col-md-6 col-12 p-3">
							<a href="#">
								<div class="bg-novidade"
									style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/novidade1.png');">
								</div>
							</a>
						</div>
						<div class="col-md-6 col-12 p-3">
							<a href="#">
								<div class="bg-novidade"
									style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/novidade2.png');">
								</div>
							</a>
						</div>
					</div>
					<div class="row p-3">
						<div class="col-md-6 col-12 p-3">
							<a href="#">
								<div class="bg-novidade"
									style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/novidade3.png');">
								</div>
							</a>
						</div>
						<div class="col-md-6 col-12 p-3">
							<a href="#">
								<div class="bg-novidade"
									style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/novidade4.png');">
								</div>
							</a>
						</div>
					</div>
				...
				<div class="col-md-4 col-12" style="padding-bottom: 10px;">
					<div class="bg-saibamais"
						style="background-image: url('<?=wp_upload_dir()['baseurl']?>/2024/06/saiba-mais.png');">
